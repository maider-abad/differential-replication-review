...
- **data**
  - Folder for storing datasets required for the project.

- **figures**
  - Folder for storing figures generated by the scripts.

- **keywords**
  - Folder related to keywords used in the analysis.

- **other_graphs**
  - Folder for additional graphs.

- **src_fonts**
  - Folder containing fonts required for graphs or visualizations.

- **src_keywords**
  - Source code for handling and analyzing keywords.

- **src_plots**
  - Source code for generating plots.

- **src_tags**
  - Source code related to tags.
